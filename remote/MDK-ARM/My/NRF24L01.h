...
#define Set_NRF24L01_CSN     (SPI_CS_GPIO_Port->BSRR = SPI_CS_Pin)
#define Clr_NRF24L01_CSN     (SPI_CS_GPIO_Port->BRR = SPI_CS_Pin)    
#define Set_NRF24L01_CE      (NRF_CE_GPIO_Port->BSRR = NRF_CE_Pin)    
#define Clr_NRF24L01_CE      (NRF_CE_GPIO_Port->BRR = NRF_CE_Pin)    
#define READ_NRF24L01_IRQ    (IRQ_GPIO_Port->IDR & IRQ_Pin)

//NRF24L01发送接收数据宽度定义
#define TX_ADR_WIDTH    5                               //5字节的地址宽度
#define RX_ADR_WIDTH    5                               //5字节的地址宽度
#define TX_PLOAD_WIDTH  17                              //17字节的用户数据宽度
#define RX_PLOAD_WIDTH  17                              //17字节的用户数据宽度
