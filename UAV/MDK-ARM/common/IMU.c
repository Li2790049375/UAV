...
// 度每秒 转换弧度每秒到 2*0.03051756 * 0.0174533f = 0.0005326*2
 ...
 * @param {Gyro_Accel_Struct} *GyroAccel mpu的6轴数据
                              ...
                              float dt)
{
    ...
    /*机体坐标系下的Z方向向量*/
    float vecxZ = 2 * NumQ.q0 * NumQ.q2 - 2 * NumQ.q1 * NumQ.q3;     /*矩阵(3,1)*/
    float vecyZ = 2 * NumQ.q2 * NumQ.q3 + 2 * NumQ.q0 * NumQ.q1;     /*矩阵(3,2)*/
    float veczZ = 1 - 2 * NumQ.q1 * NumQ.q1 - 2 * NumQ.q2 * NumQ.q2; /*矩阵(3,3)*/
